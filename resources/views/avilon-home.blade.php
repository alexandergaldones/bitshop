...
<header id="header">
    <div class="container">
        ...
        <div id="logo" class="pull-left">
            <h1><a href="#intro" class="scrollto">Bitshop.ph</a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="#intro"><img src="avilon/img/logo.png" alt="" title=""></a> -->
        </div>
    ...
    <section id="advanced-features">
        ...
        <div class="features-row">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <img class="advanced-feature-img-left" src="avilon/img/advanced-feature-2.jpg" alt="">
        ...
        <div class="container">
            ...
            <div class="row wow fadeInUp">
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="avilon/img/team/team-1.jpg" alt=""></div>
                        <h4>Walter White</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="avilon/img/team/team-2.jpg" alt=""></div>
                        <h4>Sarah Jhinson</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="avilon/img/team/team-3.jpg" alt=""></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="avilon/img/team/team-4.jpg" alt=""></div>
                        <h4>Amanda Jepson</h4>
